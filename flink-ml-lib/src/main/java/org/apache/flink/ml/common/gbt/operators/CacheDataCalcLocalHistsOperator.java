    ...
    public void onEpochWatermarkIncremented(
            ...
            invoke(
                    (getter, setter) -> {
                        ...
                        TrainContext rawTrainContext =
                                getter.getPrevEpoch(SharedObjectsConstants.TRAIN_CONTEXT);
        ...
        invoke(
                (getter, setter) -> {
                    ...
                    int numTrees = 0;
                    if (epochWatermark > 0) {
                        pgh = getter.getPrevEpoch(SharedObjectsConstants.PREDS_GRADS_HESSIANS);
                        needInitTree = getter.getPrevEpoch(SharedObjectsConstants.NEED_INIT_TREE);
                        numTrees = getter.getPrevEpoch(SharedObjectsConstants.ALL_TREES).size();
                    }
                    ...
                    if (needInitTree) {
                        ...
                        layer = getter.getPrevEpoch(SharedObjectsConstants.LAYER);
