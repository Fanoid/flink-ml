...
/** Tests {@link BinaryClassificationEvaluator2}. */
public class BinaryClassificationEvaluator2Test extends AbstractTestBase {
    ...
    public void testParam() {
        BinaryClassificationEvaluator2 binaryEval = new BinaryClassificationEvaluator2();
    ...
    public void testEvaluate() {
        BinaryClassificationEvaluator2 eval =
                new BinaryClassificationEvaluator2()
                        .setMetricsNames(
                                //
                                // BinaryClassificationEvaluatorParams.AREA_UNDER_PR,
                                //
        ...
        BinaryClassificationEvaluator2 eval =
                new BinaryClassificationEvaluator2()
                        .setMetricsNames(
                                ...
                                // BinaryClassificationEvaluatorParams.KS,
                                BinaryClassificationEvaluatorParams.AREA_UNDER_ROC);
        BinaryClassificationEvaluator2 loadedEval =
                TestUtils.saveAndReload(
                        tEnv,
                        eval,
                        tempFolder.newFolder().getAbsolutePath(),
                        BinaryClassificationEvaluator2::load);
